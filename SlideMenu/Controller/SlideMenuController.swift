...
extension SlideMenuController {
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let slidingController = UIApplication.shared.windows[0].rootViewController as? BaseController
...
class SlideMenuController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = MenuItemViewCell(style: .default, reuseIdentifier: cellId)
